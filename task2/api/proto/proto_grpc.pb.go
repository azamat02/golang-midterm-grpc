...
func (x *greetServiceLongGreetClient) Send(m *NumRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLongGreetClient) CloseAndRecv() (*NumResponse, error) {
...
func (x *greetServiceLongGreetServer) SendAndClose(m *NumResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLongGreetServer) Recv() (*NumRequest, error) {
	m := new(NumRequest)
